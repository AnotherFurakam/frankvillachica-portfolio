						...
						<div className='w-full max-w-[650px] flex flex-col gap-[30px]'>
							<div className='flex flex-col gap-2'>
								...
								<p className={`text-lavender text-[clamp(16px,2vw,17px)] font-normal overflow-hidden ${!readMore && 'h-[0] md:h-auto transition-all delay-100'}`}>
									Poseo conocimientos solidos en Html, CSS, Javascript, Typescript, así como en lenguajes backend como Java y C#. Tengo experiencia en el desarrollo de sitios web responsivos y amigables para el usuario. Disfruto enfrentar desafíaos técnicos y encontrar soluciones creativas. Además, cuento con habilidades de trabajo en equipo y comunicación efectiva, lo que me permite colaborar de manera productiva en proyectos de software. Estoy abierto a nuevas oportunidades y siempre estoy dispuesto a ampliar mis conocimientos para seguir creciendo como profesional en el campo del desarrollo web.<br></br>
